...
export const MILESTONES = [
  [100, '跑出鸭店'], [500, '跑过中华门'], [2000, '跑穿金陵'], [5000, '鸭界传说'],
];

/* 收集品图鉴(拍立得照片/手绘插画 + 民俗小注 + 鸭鸭批注 + 去哪儿)
   home:主场关卡(该关掉落加权);rare:稀有,仅主场关或无尽 800m 后掉落 */
export const ITEMS = [
  { id:'duck',  name:'盐水鸭',   note:'桂花鸭最负盛名,皮白肉嫩,金陵第一味', quip:'鸭鸭别过头去:不看,不听,不知道。', where:'📍 章云板鸭、金宏兴,老字号遍地' },
  { id:'fans',  name:'鸭血粉丝汤', note:'鸭血滑嫩粉丝爽口,南京人的一碗乡愁', quip:'……这碗里没有鸭,放心。', where:'📍 回味、鸭得堡,夫子庙周边' },
  { id:'tea',   name:'雨花茶',   note:'形如松针,绿意清雅,全国十大名茶之一', quip:'松针似的茶叶,鸭掌泡不开。', where:'📍 雨花台风景区' },
  { id:'taro',  name:'桂花糖芋苗', note:'红糖熬芋苗,桂花香里软糯拉丝', quip:'甜到拉丝的南京秋天。', where:'📍 南京大牌档、老门东' },
  { id:'plum',  name:'梅花',     note:'南京市花,梅花山上凌寒独放', quip:'市花戴在鸭头上,也算南京户口了。', where:'📍 明孝陵梅花山,2-3 月', home:1 },
  { id:'stone', name:'雨花石',   note:'天赐国宝,一枚石子一山水', quip:'捡一块揣兜里,雨花台见。', where:'📍 雨花台、六合横梁', home:4 },
  { id:'pot',   name:'牛肉锅贴', note:'七家湾老字号,金黄酥脆一口爆汁', quip:'鸭鸭:这个可以有,多来两两。', where:'📍 李记清真馆、七家湾', home:3 },
  { id:'bean',  name:'赤豆元宵', note:'桂花赤豆糊,小元宵软糯挂勺', quip:'跑完这一碗,还能再跑三关。', where:'📍 莲湖糕团店、老门东', home:3 },
  { id:'cloud', name:'云锦',     note:'寸锦寸金,江宁织造的一寸光华', quip:'鸭鸭披上它,就是金陵最靓的鸭。', where:'📍 南京云锦博物馆', home:0, rare:true },

...
export const PHOTO_COPY = {
  heading:'实物对照', actual:'实物实拍', documentary:'现场纪实', reconstruction:'复原展示', related:'相关示意',
  missing:'实物照片暂缺', loading:'照片加载中…', failed:'照片暂时无法加载', retry:'重新加载照片',
  enlarge:'放大查看照片', close:'关闭照片', source:'原始来源', license:'照片许可',
  changes:'本地处理', credits:'照片来源与许可', copyright:'照片沿用各自许可，独立于游戏原创内容的权利声明。',
...
export const ITEMS = [
  ...
  { id:'gold',  name:'金箔',     note:'龙潭金箔,万锤打成的一片轻金', quip:'轻得像鸭绒,亮得晃鸭眼。', where:'📍 栖霞龙潭金箔之乡', home:4, rare:true, cat:'craft' },
...
// 展示资格来自照片台账；风物的关卡、文案与解锁规则仍只在此维护。
for(const item of ITEMS)item.photo=!!ALBUM_PHOTOS[item.id]?.file;
...
export const MOBILE_UI = {
  ...
  "text086": "重练第一关操作",
  "text087": "图鉴照片来源与许可",
  "text088": "以下照片按各自许可使用；署名、原始来源与本地处理说明逐张列出。",
  "text089": "完整声明：",
  "text090": "游戏许可",
  "text091": "授权联系",
  "text092": "抵达城门",

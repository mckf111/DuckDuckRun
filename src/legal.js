...
export const CREDIT_SECTIONS = [
  {
    ...
    lines: [
      ...
      '完整声明见仓库 LICENSE.md。玩法类型不受版权保护；受保护的是这只鸭和这些金陵表达。',
    ],
  },
  {
    ...
    lines: [
      ...
      '仓库内为子集化 woff2，原文见 assets/fonts/OFL.txt。',
    ],
  },
  {
    title: '实景照片',
...
export const PHOTO_CREDITS = [
  ...
  ['bg_sunyard', '中山陵祭堂', 'Jiong Sheng', 'CC BY-SA 2.0'],
  ...
  ['it_stone', '雨花石', 'Caitriana Nicholson', 'CC BY-SA 2.0'],

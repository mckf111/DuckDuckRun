...
当前候选：手机体验十关推广版（2026-09-06）。竖屏主玩、横屏兼容，原生 HTML 界面；十关都有独立六段编排、两档难度、收集目标与两枚技巧印章，场景和角色统一为绘本风格。用户已用 iPhone 多次认可标杆体验，并明确以本人感受验收，不等待其他玩家测试。执行状态见 [MOBILE-UPGRADE.md](MOBILE-UPGRADE.md)，入口见 [PLAYTEST.md](PLAYTEST.md)。

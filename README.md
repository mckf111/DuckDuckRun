...
**Created with Kimi K3, Qwen3.8-Max and Grok 4.6.** 由 **GPT-6 Astra** 完成最终整合、修正与收尾。这是作者组织的项目协作署名；照片与字体另按原作者和各自许可署名，逐项来源与处理记录见 [素材说明](ASSETS.md)。Grok 辅助生成部分另按其指引保留 **Created with Grok** 署名。
